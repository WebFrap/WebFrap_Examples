 ...
 * @copyright Webfrap Developer Network <contact@webfrap.net>
 */
class ExampleElementCommenttree_Maintab_View extends WgtMaintabCustom
{
/*//////////////////////////////////////////////////////////////////////////////
// Methoden
//////////////////////////////////////////////////////////////////////////////*/
  ...
  public function displayExample( $params)
  {
    ...
    $this->setLabel('Comment Tree');
    $this->setTitle('Comment Tree');

    $this->setTemplate('example/maintab/comment_tree');
